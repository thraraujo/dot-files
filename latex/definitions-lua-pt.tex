% DEFINITIONS LUALATEX

%%%%%%%%%%%%%%%%%%%%%%%%
% FONTS AND LANGUAGES
%%%%%%%%%%%%%%%%%%%%%%%% 
\usepackage{fontspec} % For fonts management
\usepackage{polyglossia} % Babel replacement
\usepackage{luacode} % help to include lua snippets in the file 
\usepackage{fontawesome5, academicons} % A neat list of symbols
...
\hypersetup{ 
    ...
    linkcolor=myRed, % Color of internal links (sections, pages and so on)
    citecolor=myRed, % color for bibliographical citations
    urlcolor =myRed, % color for linked URL
