...
#+begin_src emacs-lisp
  ...
  (setq dashboard-startup-banner "/home/thiago/Files/2025-work/images/bomber.png")
  ;; Value can be:
...
(use-package org-roam
    :ensure t
    :custom
    (org-roam-directory (file-truename "/home/thiago/Files/2025-work/wiki/RoamNotes"))
